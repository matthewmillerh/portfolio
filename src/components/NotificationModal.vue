...
<template>
  <Transition name="modal-wrapper" @after-leave="$emit('close-modal')">
    ...
    >
      <div
        class="modal rounded-md dark:bg-gray-700 bg-gray-100 px-8 py-6 z-30 top-52 absolute left-1/2 -translate-x-1/2 font-semibold text-lg shadow-md flex flex-col items-center gap-4"
      >
