...
import TechLabel from '@/components/TechLabel.vue'
      ...
      <div>
        <ul class="text-center">
          ...
          <TechLabel>
            ...
            <template #label>Javascript</template>
          </TechLabel>
          <TechLabel>
            <template #icon>
              <font-awesome-icon icon="fa-brands fa-vuejs" size="2xl" class="pr-2" />
            </template>
            <template #label>Vue.js</template>
          </TechLabel>
          <TechLabel>
            <template #icon>
              <svg
            ...
            <template #label>Tailwind CSS</template>
          </TechLabel>
          <TechLabel>
            <template #icon>
              <font-awesome-icon icon="fa-brands fa-bootstrap" size="2xl" class="pr-2" />
            </template>
            <template #label>Bootstrap</template>
          </TechLabel>
        </ul>
      </div>
      ...
      <div>
        <ul class="text-center">
          <TechLabel>
            ...
            <template #label>Express.js</template>
          </TechLabel>
          <TechLabel>
            <template #icon>
              <font-awesome-icon icon="fa-brands fa-php" size="2xl" class="pr-2" />
            </template>
            <template #label>PHP</template>
          </TechLabel>
        </ul>
      </div>
    ...
    >
      ...
      >
        ...
        <ProjectPreviewCard
          ...
          live-link="https://www.pentique.co.za"
        >
